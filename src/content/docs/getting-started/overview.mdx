...
<CardGrid>
  ...
  <LinkCard
    ...
    description="The INC-4821 hero flow — the sample incident used across these docs — end to end: a production action is denied, an entitled owner grants a time-boxed elevation, the call succeeds on their behalf, and access expires automatically."
  />
  <LinkCard
    title="Reference"
    href="/docs/reference/"
...
The same loop in one picture — your workforce identity provider (IdP) owns your humans, PaloNexus owns your
