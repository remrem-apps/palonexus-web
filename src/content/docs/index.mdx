...
identity provider (IdP) — Okta, Entra ID, Auth0, Logto in the demo, … — owns your **humans**; PaloNexus owns your
...
During incident **INC-4821** — the sample incident used in the demo scenario across these
docs — the devops agent at Northstar, the fictional demo organization, needs to restart a
...
- **Working today:** LangChain · LangGraph · Deep Agents · workforce IdPs speaking
  OpenID Connect (OIDC) and SCIM (System for Cross-domain Identity Management) —
...
**IdP-neutral by design.** PaloNexus sits beside your existing workforce identity and access management (IAM) and never replaces
